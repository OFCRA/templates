...
OFCRA_GI_LISTE_INFANTERIE_EXCEPTIONS = ["ex001","ex002","ex003","ex004","ex005","ex006","ex007"];		// tableau de noms d'unités entre-guillemets à ne pas équiper, ex: ["nom1", "nom2"]
